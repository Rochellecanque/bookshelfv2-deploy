...
def create_user():
    ...
    new_user = User(username=data['username'], password=hashed_password, first_name=data['first_name'],
                    ...
                    gender=data['gender'], address=data['address'], latitude=latitude, longitude=longitude, profpic='')
...
def show_requests(self):
    ...
    for book in borrow_books:
        ...
        user_data['current_user'] = borrower.username
        user_data['borrower_fname'] = borrower.first_name
        user_data['borrower_lname'] = borrower.last_name
        if book.request_Date is not None:
            user_data['returnDate'] = book.request_Date
...
def get_followers(self):
    ...
    for follower in followers:
        ...
        user_data['profpic'] = base64.b64encode(user_follower.profpic)
        output.append(user_data)
    print(output)
...
def get_following(self):
    ...
    for f in following:
        ...
        user_data['profpic'] = base64.b64encode(user_following.profpic)
        output.append(user_data)
